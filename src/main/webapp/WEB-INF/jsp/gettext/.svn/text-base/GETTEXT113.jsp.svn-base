...
<body>
	...
	<div id="mainIndex">
		<div id="mainTop">
			<div id="topLeft"></div>
			<div id="topCenter">用户主账户购买某商户商品记录</div>
			<div id="topRight"></div>
		</div>
		<div id="mainBody">
			...
			<!-- <FORM method="post" action="GETTEXT011" name="CommonForm" onsubmit="" target="_blank"> -->
				...
				<ul class="singleCol">
					...
					<li id="begDt_li">
						...
						<div class="info" style="">
							<div id="begDt_m" class="hintMsg">请输入交易起始日期</div>
						</div>
					</li>
					<li id="endDt_li">
					...
					<li>
						...
						<div id="info" class="hintMsg">
							用手机支付账户购买某一商户产品用户数据记录信息包括手机号码,交易总金额,红包消费金额,消费日期,现金消费金额。 
							输入时间格式为YYYYMMDD <br />
						</div>
						<div></div>
					</li>
