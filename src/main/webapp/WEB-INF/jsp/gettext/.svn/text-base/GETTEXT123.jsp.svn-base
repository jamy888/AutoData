...
<body>
	...
	<div id="mainIndex">
		<div id="mainTop">
			<div id="topLeft"></div>
			<div id="topCenter">手机支付帐户使用用户</div>
			<div id="topRight"></div>
		</div>
		<div id="mainBody">
				...
				<ul class="singleCol">
					...
					<li id="begDt_li">
						...
						<div class="info" style="">
							<div id="begDt_m" class="hintMsg">请输入使用起始日期</div>
						</div>
					</li>
					<li id="endDt_li">
						<div class="hint">使用结束日期：</div>
						<div class="input" style="">
						...
						<div class="info" style="">
							<div id="endDt_m" class="hintMsg">请输入使用结束日期</div>
						</div>
					</li>
					<li>
						<div class="hint">备注：</div>
						<div id="info" class="hintMsg">
							手机支付帐户使用用户字段包括内部用户号，手机号码<br /> 
							输入时间格式为YYYYMMDD <br />
						</div>
						<div></div>
					</li>
