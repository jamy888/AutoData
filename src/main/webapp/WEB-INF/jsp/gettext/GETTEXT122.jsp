...
<html>
    <head>
    <title>快捷支付/手机支付/手机钱包用户到达数</title>
...
<body>
	...
	<div id="mainIndex">
		<div id="mainTop">
			<div id="topLeft"></div>
			<div id="topCenter">快捷支付/手机支付/手机钱包用户到达数</div>
			<div id="topRight"></div>
		</div>
		<div id="mainBody">
					...
					<li id="payType_li">
						...
						<div class="input" style="">
							<select id="payType" name="payType" class="singleSelect"
								...
								<option value="02">手机支付</option>
								<option value="03">手机钱包</option>
							</select>
						</div>
						<div class="info" style="">
							<div id="payType_m" class="hintMsg">请选择要查询的数据</div>
						</div>
					</li>
					<li id="begDt_li">
						<div class="hint">注册起始日期：</div>
						<div class="input" style="">
						...
						<div class="info" style="">
							<div id="begDt_m" class="hintMsg">请输入注册起始日期</div>
						</div>
					</li>
					<li id="endDt_li">
						<div class="hint">注册结束日期：</div>
						<div class="input" style="">
						...
						<div class="info" style="">
							<div id="endDt_m" class="hintMsg">请输入注册结束日期</div>
						</div>
					</li>
					<li>
						<div class="hint">备注：</div>
						<div id="info" class="hintMsg">
							快捷支付/手机支付/手机钱包用户到达数字段包括手机号码，注册时间<br /> 
							输入时间格式为YYYYMMDD <br />
						</div>
						<div></div>
					</li>
