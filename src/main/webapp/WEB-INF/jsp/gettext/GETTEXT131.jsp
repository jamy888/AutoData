...
<body>
	...
	<div id="mainIndex">
		<div id="mainTop">
			<div id="topLeft"></div>
			<div id="topCenter">电子现金账户总充值金额(联名卡)</div>
			<div id="topRight"></div>
		</div>
		<div id="mainBody">
				...
				<ul class="singleCol">
					...
					<li id="begDt_li">
						...
						<div class="info" style="">
							<div id="begDt_m" class="hintMsg">请输入充值起始日期</div>
						</div>
					</li>
					<li id="endDt_li">
						<div class="hint">充值结束日期：</div>
						<div class="input" style="">
						...
						<div class="info" style="">
							<div id="endDt_m" class="hintMsg">请输入充值结束日期</div>
						</div>
					</li>
					<li>
						<div class="hint">备注：</div>
						<div id="info" class="hintMsg">
							电子现金账户总充值金额(联名卡)字段包括联名卡帐号，总金额<br /> 
							输入时间格式为YYYYMMDD <br />
						</div>
						<div></div>
					</li>
